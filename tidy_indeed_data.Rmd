...
datascience %>% 
  mutate(degree = ifelse(str_detect(.$description,  c("[Bb]achelor", "BA", "BS", "B.S", "B.A")) == TRUE, "bachelor",
                        ifelse(str_detect(.$description, c("[Mm]aster", "M.S", "MS", "M.A", "MA", "M.P.H")) == TRUE, "master",
