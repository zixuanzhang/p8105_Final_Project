...
skill_new = datascience %>%
  mutate(
    ...
    data_mani_ana = ifelse(str_detect(.$description,  c("[Dd]ata [Aa]nalysis|[Dd]ata [Mm]anipulation|[Dd]ata [Mm]anagement|[Dd]ata [Ee]valuation|[Dd]ata [Vv]isualization|[Ss]tatistical [Aa]nalysis|[Rr]egression")) == TRUE, 1, 0),
...
datascience %>% 
  filter(str_detect(description, c("[Mm]achine [Ll]earning|[Dd]ecision [Tt]ree|[Rr]andom [Ff]orest")) == TRUE)
```
