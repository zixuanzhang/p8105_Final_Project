...
1. Data Tidying:
    i) detect key strings in the job descriptions.
    ii) Reduce redundancy
    iii) Deal with missing value
    iiii) Classification of job titles
 
2. Final product
    i) Matching statistical analysis result to the map
